...
class Profile extends Model
{
	...
	{
		$query = $this->database->query("SELECT `user_id`, `user_name`, `firstname`, `lastname`, `email`, `mobile` FROM `" . DB_PREFIX . "users` WHERE `user_id` = ? LIMIT 1", array($this->database->escape($id)));
