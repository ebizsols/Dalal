...
class ManagesalaryController extends Controller
{
	public function index()
	{
		...
		**/
		...
		$data['page_title'] = $this->language->get('text_manage_salary');
		...
		$data['page_active'] = 'managesalary';

		$data['lang']= $this->language->all();
		/*Render Managesalary list view*/
	...
	public function indexAdd()
	{
		...
		**/
		...
		$data['page_title'] = $this->language->get('text_add_manage_salary');
	...
	public function indexEdit()
	{
		...
		**/
		...
		$data['page_title'] = $this->language->get('text_edit_manage_salary');
	...
	public function indexView()
	{
		...
		**/
		...
		$data['page_title'] = $this->language->get('text_view_manage_salary');
		$data['page_edit'] = $this->user_agent->hasPermission('managesalary/edit') ? true : false;
		$data['page_history'] = $this->user_agent->hasPermission('managesalary/history') ? true : false;
		$data['action'] = URL.DIR_ROUTE.'managesalary/edit';
		$data['page_active'] = 'managesalary';
	...
	public function history()
	{
		...
		**/
		...
		$this->load->model('commons');
		$data['common'] = $this->model_commons->getCommonData($this->session->data['user_id']);
		$data['page_title'] = $this->language->get('text_payment_history');
	...
	public function historyView()
	{
		...
		**/
		...
		$data['page_title'] = $this->language->get('text_payment_history');
		$data['page_pdf'] = $this->user_agent->hasPermission('managesalary/history/pdf') ? true : false;
		$data['page_active'] = 'managesalary';
	...
	**/
	public function makepayment()
	{
		...
		**/
		...
		$data['page_title'] = $this->language->get('text_make_payment');
		...
		$data['page_managesalary_add'] = $this->user_agent->hasPermission('managesalary/add') ? true : false;
		$data['page_active'] = 'makepayment';
	...
	public function makepaymentAdd()
	{
		...
		**/
		...
		$data['page_title'] = $this->language->get('text_make_payment');
		$data['page_history'] = $this->user_agent->hasPermission('managesalary/history') ? true : false;
		$data['page_history_view'] = $this->user_agent->hasPermission('managesalary/history/view') ? true : false;
		$data['page_history_delete'] = $this->user_agent->hasPermission('managesalary/history/delete') ? true : false;
		$data['action_delete'] = URL.DIR_ROUTE.'managesalary/history/delete';
	...
	public function checkStaffSalary()
	{
		...
		if (empty($data['id']) || !is_int($data['id'])) {
			echo json_encode(array('error' => true, 'msg' => 'User is not valid!'));
			exit();
		}
