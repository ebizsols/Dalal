...
class LoginController extends Controller
{
	public function index()
	{
		...
		$data['common']['url_route'] = URL.DIR_ROUTE;
	...
	public function sendForgotMail($data)
	{
		...
		$result['template']['message'] = str_replace('{name}', $data['firstname'], $result['template']['message']);
	...
	public function resetpassword()
	{
		...
		$data['lang']['login'] = $this->language->load('login', 'login');
		/**
	...
	public function sendResetMail($data)
	{
		$this->load->model('commons');
		$this->load->controller('mail');
		$result = $this->controller_mail->getTemplate('resetpassword');
