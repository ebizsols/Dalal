...
class StaffattendanceController extends Controller
{
	public function index()
	{
		...
		**/
		...
		/*Load Language File*/
		$this->language->load('attendance', 'attendance');
		
		$data['page_title'] = $this->language->get('text_attendance');
	...
	public function indexAdd()
	{
		...
		**/
		...
		$data['page_title'] = $this->language->get('text_add_attendance');
		$data['token'] = hash('sha512', TOKEN . TOKEN_SALT);
		$data['action'] = URL.DIR_ROUTE.'staffattendance/add';
		$data['page_active'] = 'attendance';
	...
	public function indexAction()
	{
		...
		$data['day'] = DateTime::createFromFormat($common['date_format'], $data['attendence_date'])->format('d');
		$data['month'] = DateTime::createFromFormat($common['date_format'], $data['attendence_date'])->format('m');
		$data['year'] = DateTime::createFromFormat($common['date_format'], $data['attendence_date'])->format('Y');
		$data['day'] = ltrim($data['day'], '0');
